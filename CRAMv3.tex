...
It is not mandatory to use this deduplication approach and optionally tools may wish to label data as detached even when all records for the template reside in the same slice.
One example reason for this may be to encode inconsistent data in order to preserve round-trips in to and out of the CRAM format.
